...
function modelDataBuilder(_name, _model, _properties) {
    ...
    function createModel(params, _callback) {
        ...
        for (var property in self.modelProperties)
            if (modelPropSet[property] !== null || modelPropSet[property] !== undefined || modelPropSet === "")
                var model = new self.Model({
                    id: self.__uuid()(),
                    name: modelPropSet.name,
                    surname: modelPropSet.surname,
                    age: modelPropSet.age,
                    married: modelPropSet.married
                });
    ...
    function editModel(_params, _updatedModel, _callback) {
        ...
        self.getmodel(_params, function(model) {
...
modelDataBuilder.prototype__modelPropertySetBuilder = function(_rawQueryObj) {
...
module.exports = modelDataBuilder;